...
# (``app.providers.factory``) resolve OpenAI providers straight to
# ``app.providers.openai_client`` and ``build_runtime_provider``. The only
...
def create_provider() -> Provider:
    ...
    """
    return build_runtime_provider(PROVIDER_REGISTRY["openai"])
